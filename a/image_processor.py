...
class ImageProcessor:
    ...
    def add_text(self):
        ...
        # Загрузка шрифта Arial в обычном стиле (без жирности)
        try:
            font = ImageFont.truetype("arial.ttf", 36)  # Путь к шрифту Arial, размер 36
        except IOError:
            font = ImageFont.load_default()  # Используем дефолтный шрифт, если Arial не найден
